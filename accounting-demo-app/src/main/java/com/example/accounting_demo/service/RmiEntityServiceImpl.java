...
@Component
public class RmiEntityServiceImpl implements RmiEntityService {
    private static final Logger logger = LoggerFactory.getLogger(RmiEntityServiceImpl.class);
    ...
    public RmiEntityServiceImpl(ObjectMapper om, JsonToEntityListParser jsonToEntityListParser, JsonToEntityParser jsonToEntityParser, Authentication authentication) {
        this.om = om;
    ...
    public SerializableHttpResponse saveEntityModel(String entity, String model, String modelVersion) throws IOException {

        String url = String.format("%s/api/treeNode/model/import/JSON/SAMPLE_DATA/%s/%s", host, model, modelVersion);
        ...
        try (CloseableHttpResponse response = httpClient.execute(httpPost)) {
            ...
            return new SerializableHttpResponse(statusCode, responseBody);
        }
    }

    public SerializableHttpResponse lockEntityModel(String model, String modelVersion) throws IOException {

        String url = String.format("%s/api/treeNode/model/%s/%s/lock", host, model, modelVersion);
    ...
    public SerializableHttpResponse deleteEntityModel(String modelName, String modelVersion) throws IOException {
...
//    public SerializableHttpResponse deleteEntityModel(String modelName) throws IOException {
//        return deleteEntityModel(modelName, MODEL_VERSION);
//    }

    public SerializableHttpResponse saveEntity(String entity, String model, String modelVersion) throws IOException {

        String url = String.format("%s/api/entity/new/JSON/TREE/%s/%s", host, model, modelVersion);
        HttpPost httpPost = new HttpPost(url);
    ...
    public SerializableHttpResponse getAllEntitiesAsJson(String model, String version) throws IOException {
        return getAllEntitiesAsJson(model, version, "100", "1");
    }

    public SerializableHttpResponse getAllEntitiesAsJson(String model, String version, String pageSize) throws IOException {
        return getAllEntitiesAsJson(model, version, pageSize, "1");
    }

    public SerializableHttpResponse getAllEntitiesAsJson(String model, String version, String pageSize, String pageNumber) throws IOException {
        String url = String.format("%s/api/entity/TREE/%s/%s?pageSize=%s&pageNumber=%s", host, model, version, pageSize, pageNumber);
        return getRequest(url);
    }

    public SerializableHttpResponse getByIdAsJson(UUID id) throws IOException {
        String url = String.format("%s/api/entity/TREE/%s", host, id);
        return getRequest(url);
    }

    public SerializableHttpResponse deleteEntityById(String modelName, String modelVersion, String id) throws IOException {
        String url = String.format(host + "/api/entity/TREE/%s/%s/%s", modelName, modelVersion, id);
        HttpDelete httpDelete = new HttpDelete(url);
    ...
    public SerializableHttpResponse deleteAllEntitiesByModel(String modelName, String modelVersion) throws IOException {
...
//    public SerializableHttpResponse deleteAllEntitiesByModel(String modelName) throws IOException {
...
//    }
    ...
    public SerializableHttpResponse getRequest(String url) throws IOException {
        HttpGet httpGet = new HttpGet(url);
        httpGet.setConfig(requestConfig);
        httpGet.setHeader("Authorization", "Bearer " + token);
    ...
    public SerializableHttpResponse launchTransition(UUID id, String transition) throws IOException {
    ...
    public SerializableHttpResponse getListTransitions(UUID id) throws IOException {
        String entityId = id.toString();
        ...
        try (CloseableHttpResponse response = httpClient.execute(httpGet)) {
            ...
            return new SerializableHttpResponse(statusCode, result);
        }
    }

    public SerializableHttpResponse getCurrentState(UUID id) throws IOException {
        String entityId = id.toString();
        ...
        try (CloseableHttpResponse response = httpClient.execute(httpGet)) {
            ...
            int statusCode = response.getStatusLine().getStatusCode();
            String result = jsonNode.get(0).get("value").asText();

            return new SerializableHttpResponse(statusCode, result);
        }
        catch (Exception e) {
            int statusCode = HttpStatus.SC_NOT_FOUND;
            String result = "entity not found";
            return new SerializableHttpResponse(statusCode, result);
        }
    }
